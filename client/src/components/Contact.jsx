            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-earth-700 dark:text-earth-300 font-semibold text-lg">(801) 369-8515</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Call us for immediate assistance</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-earth-700 dark:text-earth-300 font-semibold text-lg break-all">mikewarrenconstruction@outlook.com</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Send us your project details</p>
                </div>
              </a>

              <div className="flex items-start space-x-4 p-6 bg-earth-50 dark:bg-slate-800 rounded-lg">
                <div className="flex-shrink-0">
              ...
              <div className="flex items-start space-x-4 p-6 bg-earth-50 dark:bg-slate-800 rounded-lg">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Service Area</h4>
                  <p className="text-gray-700 dark:text-gray-300">Utah County & Surrounding Areas</p>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">Licensed B100 General Contractor</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-earth-500 focus:border-earth-500 outline-none transition-colors ${
              ...
              <div>
                <label htmlFor="projectType" className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">
                  Project Type *
                </label>
                <select
                  id="projectType"
                  ...
                  onChange={handleChange}
                  className={`w-full h-12 px-4 py-3 border rounded-lg bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-earth-500 focus:border-earth-500 outline-none transition-colors ${
                    errors.projectType ? 'border-red-500' : 'border-gray-300 dark:border-slate-700'
                  }`}
                  required
                >
              ...
              <div>
                <label htmlFor="projectDescription" className="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">
                  Project Description *
                </label>
                <textarea
                  ...
                  onChange={handleChange}
                  rows="5"
                  className={`w-full px-4 py-3 border rounded-lg bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-earth-500 focus:border-earth-500 outline-none transition-colors resize-none ${
                    errors.projectDescription ? 'border-red-500' : 'border-gray-300 dark:border-slate-700'
                  }`}
